                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        @if($book->publication_year)
                                            <p class="text-xs text-gray-500 mt-1">{{ $book->publication_year }} • {{ $book->publisher }}</p>
                                        @endif
                                    </div>
                                </div>
                            </td>
    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-6">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden transform transition-all">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                <form action="{{ route('library.books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
    <label class="block text-sm font-medium text-gray-700 mb-2">Category *</label>
    <select name="book_category_id" required  <!-- Changed from category_id -->
            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-colors">
...
<script>
    ...
    function applyFilters() {
        ...
        let url = '{{ route('library.books.index') }}?';
