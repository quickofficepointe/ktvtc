                        ...
                        <tr class="hover:bg-amber-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="confirmDelete('{{ route('library.book-categories.destroy', $category->id) }}')"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-6">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden transform transition-all">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                <form action="{{ route('library.book-categories.store') }}" method="POST" class="space-y-6">
                    @csrf
...
<script>
    ...
    function openEditModal(categoryId) {
        fetch(`/library/book-categories/${categoryId}`)
            ...
            .then(data => {
                ...
                document.getElementById('editForm').action = `/library/book-categories/${categoryId}`;
