    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-6">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden transform transition-all">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                <form action="{{ route('library.transactions.store') }}" method="POST" class="space-y-6">
                    @csrf
...
<script>
    ...
    function filterByStatus(status) {
        window.location.href = '{{ route('library.transactions.index') }}?status=' + status;
    }

    function clearFilters() {
        window.location.href = '{{ route('library.transactions.index') }}';
    }
    ...
    function applyFilters() {
        ...
        let url = '{{ route('library.transactions.index') }}?';
    ...
    function returnBook(transactionId) {
        if(confirm('Mark this book as returned?')) {
            ...
            form.method = 'POST';
            form.action = `/library/transactions/${transactionId}/return`;
