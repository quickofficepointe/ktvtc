...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            <a href="{{ route('library.transactions.index') }}" class="block text-center text-primary hover:underline mt-4">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            <a href="{{ route('library.fine-rules.index') }}" class="block text-center text-primary hover:underline mt-4">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            <a href="{{ route('library.book-popularities.index') }}" class="block text-center text-primary hover:underline mt-4">
        ...
        <div class="bg-white rounded-xl shadow-md">
            <div class="p-6 border-b">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('library.transactions.index') }}" class="text-primary hover:underline text-sm">
            ...
            <div class="bg-white rounded-xl shadow-md">
                <div class="p-6 border-b">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('library.members.index') }}" class="text-primary hover:underline text-sm">
                            View all <i class="fas fa-external-link-alt ml-1"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <a href="{{ route('library.transactions.index') }}"
                        ...
                        <a href="{{ route('library.acquisition-requests.index') }}"
                           class="flex flex-col items-center justify-center p-4 border rounded-lg hover:bg-gray-50 transition">
