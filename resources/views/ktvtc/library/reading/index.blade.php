    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-6">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden transform transition-all">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                <form action="{{ route('library.reading-histories.store') }}" method="POST" class="space-y-6">
                    @csrf
...
<script>
    ...
    function applyFilters() {
        ...
        let url = '{{ route('library.reading-histories.index') }}?';
    ...
    function viewHistory(historyId) {
        window.location.href = `/library/reading-histories/${historyId}`;
    }
