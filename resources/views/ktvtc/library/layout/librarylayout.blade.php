    ...
    <div class="fixed top-16 left-0 bottom-0 w-64 text-white z-20 overflow-y-auto sidebar hidden md:block" id="sidebar">
        <div class="p-4">
            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('library.books.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('books.*') ? 'active' : '' }}">
                        <i class="fas fa-book mr-3"></i> Books
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.items.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('items.*') ? 'active' : '' }}">
                        <i class="fas fa-copy mr-3"></i> Book Copies
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.authors.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('authors.*') ? 'active' : '' }}">
                        <i class="fas fa-user-edit mr-3"></i> Authors
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.book-categories.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('book-categories.*') ? 'active' : '' }}">
...
<li>
    <a href="{{ route('library.ebooks.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('ebooks.*') ? 'active' : '' }}">
        <i class="fas fa-tablet-alt mr-3"></i> E-Books
                ...
                <li>
                    <a href="{{ route('library.members.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('members.*') ? 'active' : '' }}">
                        <i class="fas fa-users mr-3"></i> Members
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.transactions.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('transactions.*') ? 'active' : '' }}">
                        <i class="fas fa-exchange-alt mr-3"></i> Transactions
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.reservations.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('reservations.*') ? 'active' : '' }}">
                        <i class="fas fa-calendar-check mr-3"></i> Reservations
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.reading-histories.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('reading-histories.*') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('library.acquisition-requests.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('acquisition-requests.*') ? 'active' : '' }}">
                        <i class="fas fa-shopping-cart mr-3"></i> Acquisition Requests
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.weeding-candidates.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('weeding-candidates.*') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('library.book-popularities.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('book-popularities.*') ? 'active' : '' }}">
                        <i class="fas fa-chart-line mr-3"></i> Book Popularity
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.usage-statistics.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('usage-statistics.*') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('library.branches.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('branches.*') ? 'active' : '' }}">
                        <i class="fas fa-building mr-3"></i> Branches
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.fine-rules.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('fine-rules.*') ? 'active' : '' }}">
                        <i class="fas fa-money-check-alt mr-3"></i> Fine Rules
                    </a>
                </li>
                <li>
                    <a href="{{ route('library.notifications.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('notifications.*') ? 'active' : '' }}">
