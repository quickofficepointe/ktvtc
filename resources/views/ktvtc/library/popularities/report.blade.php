...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('library.book-popularities.index') }}"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-amber-200 p-6 mb-8">
        <div class="flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
            ...
            <div class="flex space-x-4">
                <a href="{{ route('library.book-popularities.report') }}?timeframe=week"
                ...
                <a href="{{ route('library.book-popularities.report') }}?timeframe=month"
