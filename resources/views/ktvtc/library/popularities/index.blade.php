...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('library.book-popularities.report') }}"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-blue-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <form action="{{ route('library.book-popularities.refresh') }}" method="POST" class="mt-2">
                        @csrf
                        ...
                        <tr class="hover:bg-amber-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ route('library.book-popularities.update', $popularity) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('POST')
                                        <button type="submit"
...
<script>
    ...
    function openEditModal(popularityId) {
        fetch(`/library/book-popularities/${popularityId}/edit`)
            ...
            .then(data => {
                ...
                document.getElementById('editForm').action = `/library/book-popularities/${popularityId}/update`;
    ...
    function applyFilters() {
        ...
        let url = '{{ route('library.book-popularities.index') }}?';
