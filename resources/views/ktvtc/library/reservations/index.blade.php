                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1">
                                            {{ $reservation->member->member_id }} • {{ $reservation->branch->name }}
                                        </p>
    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-6">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden transform transition-all">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                <form action="{{ route('library.reservations.store') }}" method="POST" class="space-y-6">
                    @csrf
...
<script>
    ...
    function filterByStatus(status) {
        window.location.href = '{{ route('library.reservations.index') }}?status=' + status;
    }
    ...
    function fulfillReservation(reservationId) {
        if(confirm('Mark this reservation as fulfilled?')) {
            ...
            form.method = 'POST';
            form.action = `/library/reservations/${reservationId}/fulfill`;
    ...
    function cancelReservation(reservationId) {
        if(confirm('Cancel this reservation?')) {
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = `/library/reservations/${reservationId}/cancel`;
    ...
    function viewReservation(reservationId) {
        window.location.href = `/library/reservations/${reservationId}`;
    }
