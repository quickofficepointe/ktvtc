...
<script>
    ...
    function generateMonthlyReport() {
        ...
        window.location.href = `/library/usage-statistics/export/monthly?start_date=${startDate}&end_date=${endDate}`;
    }
    ...
    function generateAnnualReport() {
        ...
        window.location.href = `/library/usage-statistics/export/annual?start_date=${startDate}&end_date=${endDate}`;
    }

    // View Daily Details
    function viewDailyDetails(statId) {
        fetch(`/library/usage-statistics/${statId}/details`)
    ...
    function exportDailyReport(statId) {
        window.location.href = `/library/usage-statistics/${statId}/export`;
    }
