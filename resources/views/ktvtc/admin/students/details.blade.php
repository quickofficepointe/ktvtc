...
<li>
    <div class="flex items-center">
        ...
        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">
            <a href="{{ route('admin.students.show', $student) }}" class="hover:text-primary">
...
<div class="flex space-x-2">
    <a href="{{ route('admin.students.details.edit', $student) }}"
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                ...
                <a href="{{ route('admin.students.details.edit', $student) }}" class="text-primary hover:text-primary-dark text-sm">
