                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900">{{ $application->id_number }}</p>
                            </div>
                            <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900">{{ ucfirst(str_replace('_', ' ', $application->study_mode)) }}</p>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div>
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        <a href="{{ Storage::url($application->id_document) }}"
                           target="_blank"
                           class="flex items-center justify-center gap-2 w-full border border-primary text-primary hover:bg-primary hover:text-white px-4 py-3 rounded-lg transition-colors duration-200">
