            ...
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    <ul class="submenu ml-6 mt-1 space-y-1" id="categoriesSubmenu">
                        <li>
                            <a href="{{ route('mschool.course-categories.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md nav-link {{ request()->routeIs('mschool.course-categories.*') ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <ul class="submenu ml-6 mt-1 space-y-1" id="coursesSubmenu">
                        <li>
                            <a href="{{ route('mschool.mcourses.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md nav-link {{ request()->routeIs('mschool.mcourses.*') ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <ul class="submenu ml-6 mt-1 space-y-1" id="studentsSubmenu">
                        <li>
                            <a href="{{ route('mschool.students.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md nav-link {{ request()->routeIs('mschool.students.*') ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <ul class="submenu ml-6 mt-1 space-y-1" id="subjectsSubmenu">
                        <li>
                            <a href="{{ route('mschool.subjects.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md nav-link {{ request()->routeIs('mschool.course-subjects.*') ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <ul class="submenu ml-6 mt-1 space-y-1" id="enrollmentsSubmenu">
                        <li>
                            <a href="{{ route('mschool.enrollments.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md nav-link {{ request()->routeIs('mschool.enrollments.*') ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <ul class="submenu ml-6 mt-1 space-y-1" id="examsSubmenu">
                        <li>
                            <a href="{{ route('mschool.exams.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md nav-link {{ request()->routeIs('mschool.exams.*') ? 'active' : '' }}">
                                <i class="fas fa-list mr-3"></i> All Exams
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('mschool.exam-results.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md nav-link {{ request()->routeIs('mschool.exam-results.*') ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <ul class="submenu ml-6 mt-1 space-y-1" id="certificatesSubmenu">
                        <li>
                            <a href="{{ route('mschool.certificate-templates.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md nav-link {{ request()->routeIs('mschool.certificate-templates.*') ? 'active' : '' }}">
                                <i class="fas fa-file-contract mr-3"></i> Templates
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('mschool.certificates.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md nav-link {{ request()->routeIs('mschool.certificates.*') ? 'active' : '' }}">
                ...
                <!-- Attendance Section -->
                <li>
                    <a href="{{ route('mschool.attendances.index') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('mschool.attendances.*') ? 'active' : '' }}">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const activeRoutes = {
                ...
                'mcourses': 'coursesSubmenu',
                'students': 'studentsSubmenu',
                'subjects': 'subjectsSubmenu',
            ...
            Object.entries(activeRoutes).forEach(([route, submenuId]) => {
                if (window.location.href.includes(route)) {
                    if (submenuId === 'attendances') {
                        // Attendance is a single link, not a submenu
                        return;
                    }
                    const submenu = document.getElementById(submenuId);
