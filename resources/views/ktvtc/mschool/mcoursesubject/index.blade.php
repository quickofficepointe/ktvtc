                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150 align-top">
                            ...
                            <td class="px-6 py-4 align-top">
                                <div class="flex gap-2">
                                    ...
                                    <button onclick="confirmDelete('{{ route('mschool.mcourse-subjects.destroy', $courseSubject->course_subject_id) }}')" class="px-3 py-1 text-xs rounded bg-red-50 text-red-600 hover:bg-red-100">Delete</button>
                                </div>
                            </td>
                        </tr>
                    @empty
    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-6">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden transform transition-all">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                <form action="{{ route('mschool.course-subjects.store') }}" method="POST" class="space-y-6">
                    @csrf
...
<script>
    ...
    function openEditModal(id, courseId, subjectId, semester, year, isCompulsory, creditHours, sortOrder) {
        ...
        editForm.action = '{{ route("mschool.course-subjects.update", "") }}/' + id;
