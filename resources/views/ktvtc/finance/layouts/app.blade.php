    ...
    <div class="flex items-center justify-between h-full px-3 sm:px-4 md:px-6">
        <div class="flex items-center min-w-0 flex-1">
            ...
            <a href="{{ route('finance.dashboard') }}" class="flex items-center min-w-0 flex-shrink">
                ...
                <span class="font-bold text-white text-base sm:text-lg truncate">Finance</span>
            </a>
        </div>
        ...
        <div class="flex items-center space-x-1 sm:space-x-3 flex-shrink-0">
            <div class="relative">
                <button id="userBtn" class="flex items-center text-white hover:bg-white/10 px-2 py-1.5 rounded-lg transition-colors touch-target" aria-label="User menu">
                    ...
                    <span class="hidden sm:block ml-2 text-sm font-medium max-w-[120px] truncate">{{ Auth::user()->name ?? 'Finance Officer' }}</span>
                ...
                <div id="userMenu" class="hidden absolute right-0 mt-2 w-48 sm:w-52 bg-white rounded-xl shadow-xl z-50 border border-gray-100 overflow-hidden">
                    <div class="py-1.5">
                        <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 active:bg-gray-100">
                            <i class="fas fa-user w-4 mr-3 text-gray-400 text-center"></i> My Profile
                        </a>
                        <a href="{{ route('finance.settings.index') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 active:bg-gray-100">
        ...
        <ul class="space-y-0.5">
            ...
            <li>
                <a href="{{ route('finance.dashboard') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.dashboard') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.student-fees.index') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.student-fees.*') && !request()->routeIs('finance.student-fees.create') && !request()->routeIs('finance.student-fees.reports.*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.student-fees.create') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.student-fees.create') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.student-fees.reports.outstanding') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.student-fees.reports.*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.transactions.index') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.transactions.*') && !request()->routeIs('finance.transactions.mpesa') && !request()->routeIs('finance.transactions.pending') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.transactions.mpesa') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.transactions.mpesa') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.transactions.pending') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.transactions.pending') ? 'active' : '' }}">
                    <i class="fas fa-clock w-5 mr-3 text-center"></i>
                    <span>Pending</span>
                    @php
            ...
            <li>
                <a href="{{ route('finance.reports.profit-loss') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.reports.profit-loss') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.reports.revenue') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.reports.revenue') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.reports.expenses') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.reports.expenses') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.reports.balance-sheet') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.reports.balance-sheet') ? 'active' : '' }}">
                    <i class="fas fa-balance-scale w-5 mr-3 text-center"></i>
                    <span>Balance Sheet</span>
                </a>
            </li>
            <li>
                <a href="{{ route('finance.reports.cashflow') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.reports.cashflow') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.students.search') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.students.*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('finance.settings.financial-year') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg nav-link touch-target {{ request()->routeIs('finance.settings.financial-year') ? 'active' : '' }}">
...
<main class="main-content pt-16 min-h-screen">
    ...
    <div class="bg-white border-b px-3 py-3 sm:px-4 md:px-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
                <h1 class="text-lg sm:text-xl font-bold text-gray-800 truncate">@yield('title', 'Finance Dashboard')</h1>
                <p class="text-xs sm:text-sm text-gray-500 truncate">@yield('subtitle', 'Finance Management Portal')</p>
            </div>
    ...
    <div class="px-3 pt-3 sm:px-4 md:px-6">
        ...
        @endif
        @if(session('info'))
            <div class="mb-3 p-3 bg-blue-100 border-l-4 border-blue-500 text-blue-700 rounded shadow-sm text-sm">
    ...
    <footer class="border-t bg-white px-3 py-3 sm:px-4 md:px-6 text-center text-gray-500 text-xs sm:text-sm mt-6">
        <p>KTVTC Finance Department v1.0 &copy; {{ date('Y') }}</p>
    </footer>
</main>
