...
<li>
    <span class="mx-2">/</span>
    <span class="text-gray-400">Fee Structure</span>
</li>
@endsection
...
<div class="space-y-6">
    ...
    <div class="finance-card p-6">
        <h3 class="font-bold text-gray-800 text-lg mb-4">Default Fee Structure</h3>
    ...
    <div class="finance-card p-6">
        <div class="flex justify-between items-center mb-4">
            <h3 class="font-bold text-gray-800 text-lg">Course-Specific Fee Structures</h3>
...
<div id="addCourseFeeModal" class="hidden fixed inset-0 z-50 modal-overlay flex items-center justify-center">
    <div class="bg-white rounded-xl p-6 max-w-md w-full modal-content">
        <div class="flex justify-between items-center mb-4">
            ...
            <button onclick="closeModal('addCourseFeeModal')" class="text-gray-400 hover:text-gray-600">
                <i class="fas fa-times"></i>
            </button>
        </div>
        <form method="POST" action="{{ route('finance.settings.fee-structure.store') }}">
            @csrf
            <div class="space-y-4">
                <div>
                ...
                <div>
                    <label class="text-sm font-medium text-gray-700">Tuition Fee *</label>
                ...
                <div>
                    <label class="text-sm font-medium text-gray-700">Registration Fee *</label>
                ...
                <div>
                    <label class="text-sm font-medium text-gray-700">Examination Fee *</label>
                ...
                <div>
                    <label class="text-sm font-medium text-gray-700">Library Fee *</label>
            ...
            <div class="flex justify-end space-x-3 mt-6 pt-4 border-t">
                <button type="button" onclick="closeModal('addCourseFeeModal')" class="px-4 py-2 border rounded-lg hover:bg-gray-50">Cancel</button>
