                ...
                @forelse($partners as $index => $partner)
                    ...
                    <div id="editPartnerModal{{ $partner->id }}" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                        <div class="bg-white rounded-lg p-6 w-full max-w-lg">
                            ...
                            <form action="{{ route('website.partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="space-y-4">
                                    <div>
                    ...
                    <div id="deletePartnerModal{{ $partner->id }}" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                        <div class="bg-white rounded-lg p-6 w-full max-w-md">
                            ...
                            <form action="{{ route('website.partners.destroy', $partner->id) }}" method="POST" class="mt-4 flex justify-end space-x-2">
                                @csrf
                                @method('DELETE')
