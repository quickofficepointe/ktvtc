        ...
        <div class="space-y-1 text-center">
            ...
            <div class="flex text-sm text-gray-600">
                <label for="create_cover_image"
                    ...
                    <input id="create_cover_image" name="cover_image" type="file" class="sr-only" accept="image/*">
                </label>
...
<div id="editModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
    ...
    <div class="mt-1 flex flex-col items-center justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
        <div class="space-y-1 text-center">
            ...
            <div class="flex text-sm text-gray-600">
                <label for="edit_cover_image"
                    ...
                    <input id="edit_cover_image" name="cover_image" type="file" class="sr-only" accept="image/*">
                </label>
                <p class="pl-1">or drag and drop</p>
            </div>
            <p class="text-xs text-gray-500">PNG, JPG, GIF up to 2MB</p>
        ...
        <img id="editPreview" class="mt-4 w-32 h-32 object-cover rounded-lg shadow hidden" />
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Content *</label>
                            <textarea name="content" class="summernote" id="editContent" rows="12"
...
function openEditModal(blogId) {
    ...
    fetch(`/blogs/${blogId}`)
        ...
        .then(data => {
            ...
            // Set form action
            document.getElementById('editForm').action = `/blogs/${blogId}`;
  ...
  document.getElementById('editFeatured').checked = data.featured; // Add this line
            // You can also show current cover image preview here if needed
            if (data.cover_image) {
...
document.getElementById('create_cover_image').addEventListener('change', function(e) {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            // You can add a preview container if needed
...
<script>
    ...
    // Attach listeners
    document.getElementById('create_cover_image')?.addEventListener('change', function () {
        previewImage(this, 'createPreview');
    });

    document.getElementById('edit_cover_image')?.addEventListener('change', function () {
        previewImage(this, 'editPreview');
    });
</script>
