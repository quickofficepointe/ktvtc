                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="confirmDelete('{{ route('website.banners.destroy', $banner->id) }}')"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-6">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden transform transition-all">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                <form action="{{ route('website.banners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
