...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="{{ route('website.blogs.index') }}" class="bg-white rounded-lg shadow p-4 hover:shadow-md transition duration-300 flex items-center justify-center flex-col text-center hover:bg-blue-50 group">
            ...
            <a href="{{ route('website.events.index') }}" class="bg-white rounded-lg shadow p-4 hover:shadow-md transition duration-300 flex items-center justify-center flex-col text-center hover:bg-green-50 group">
            ...
            <a href="{{ route('website.galleries.index') }}" class="bg-white rounded-lg shadow p-4 hover:shadow-md transition duration-300 flex items-center justify-center flex-col text-center hover:bg-purple-50 group">
            ...
            <a href="{{ route('website.mschools.index') }}" class="bg-white rounded-lg shadow p-4 hover:shadow-md transition duration-300 flex items-center justify-center flex-col text-center hover:bg-red-50 group">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        <a href="{{ route('website.banners.index') }}" class="flex items-center p-3 hover:bg-gray-50 rounded transition duration-200 group">
                        ...
                        <a href="{{ route('website.campuses.index') }}" class="flex items-center p-3 hover:bg-gray-50 rounded transition duration-200 group">
                            <i class="fas fa-school text-blue-600 mr-3 group-hover:text-blue-800"></i>
                            <span class="group-hover:text-blue-800">Campuses</span>
                        </a>
                        <a href="{{ route('website.testimonials.index') }}" class="flex items-center p-3 hover:bg-gray-50 rounded transition duration-200 group">
                        ...
                        <a href="{{ route('website.downloads.index') }}" class="flex items-center p-3 hover:bg-gray-50 rounded transition duration-200 group">
                        ...
                        <a href="{{ route('website.faqs.index') }}" class="flex items-center p-3 hover:bg-gray-50 rounded transition duration-200 group">
                        ...
                        <a href="{{ route('website.departments.index') }}" class="flex items-center p-3 hover:bg-gray-50 rounded transition duration-200 group">
                        ...
                        <a href="{{ route('website.partners.index') }}" class="flex items-center p-3 hover:bg-gray-50 rounded transition duration-200 group">
                        ...
                        <a href="{{ route('website.policies.index') }}" class="flex items-center p-3 hover:bg-gray-50 rounded transition duration-200 group">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="text-center py-4">
                            ...
                            <a href="{{ route('website.events.index') }}" class="text-blue-600 hover:text-blue-800 hover:underline text-sm mt-1 inline-block transition duration-200">Schedule an event</a>
                        </div>
                        @endforelse
                    </div>
                    @if($upcomingEvents->isNotEmpty())
                    <div class="mt-4 text-center">
                        <a href="{{ route('website.events.index') }}" class="text-blue-600 hover:text-blue-800 hover:underline text-sm transition duration-200">View All Events →</a>
                    </div>
                    @endif
                </div>
            </div>
    ...
    <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-3 hover:bg-gray-50 rounded transition duration-200 group">
                        <div class="flex items-center">
                            ...
                            <div>
                                <a href="{{ route('website.blogs.show', $blog->id) }}" class="font-medium text-gray-800 group-hover:text-blue-600">
                    ...
                    <div class="text-center py-8">
                        ...
                        <a href="{{ route('website.blogs.index') }}" class="text-blue-600 hover:text-blue-800 hover:underline mt-2 inline-block transition duration-200">Create your first post</a>
                    </div>
                    @endforelse
                </div>
                <div class="mt-6 text-center">
                    <a href="{{ route('website.blogs.index') }}" class="text-blue-600 hover:text-blue-800 hover:underline font-medium transition duration-200">View All Posts →</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow">
            ...
            <div class="p-6">
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('website.messages.index') }}" class="text-blue-600 hover:text-blue-800 hover:underline font-medium transition duration-200">View All Messages →</a>
                </div>
            </div>
        </div>
    </div>
