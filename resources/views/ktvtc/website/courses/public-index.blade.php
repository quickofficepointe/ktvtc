                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                        <a href="{{ route('application.form') }}"
                           class="bg-[#B91C1C] text-white font-semibold px-5 py-2.5 rounded-lg hover:bg-[#991B1B] transition-all duration-200 text-sm shadow-md hover:shadow-lg flex items-center">
