                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-blue-100 text-sm">Upload multiple images to a gallery</p>
                        </div>
                    </div>
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                <form id="addImagesForm" method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="multiple_images" class="relative cursor-pointer bg-white rounded-md font-medium text-primary hover:text-red-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary">
                                        ...
                                        <input id="multiple_images" name="images[]" type="file" multiple class="sr-only" accept="image/*" required>
                                    </label>
                                    <p class="pl-1">or drag and drop</p>
                                </div>
                    ...
                    <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit"
                                class="px-6 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl transform hover:scale-105">
                            Upload Images
                        </button>
                    </div>
                </form>
...
<script>
    ...
    function openEditModal(id, title, description, isActive) {
        ...
        // Set form action
        document.getElementById('editForm').action = `/galleries/${id}`;
    ...
    function deleteImage(galleryId, imageId) {
        if(confirm('Are you sure you want to delete this image?')) {
            fetch(`/galleries/${galleryId}/images/${imageId}`, {
                method: 'DELETE',
                headers: {
