...
@endphp
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-8 max-w-md mx-auto">
                    <h3 class="text-xl font-semibold text-green-800 mb-4 flex items-center justify-center">
                    ...
                    <div class="space-y-2 text-left">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-green-800">KES {{ number_format($payment->amount, 2) }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8 max-w-md mx-auto">
                    <h3 class="text-xl font-semibold text-yellow-800 mb-4 flex items-center justify-center">
                        <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"/>
                        </svg>
                        Pending Payment
                    </h3>
                    <p class="text-yellow-700 mb-4">Complete your application by paying the registration fee of KES 500.</p>
                    <a href="{{ route('application.payment.form', $application->id) }}"
                       class="inline-block bg-yellow-600 text-white px-6 py-3 rounded-lg hover:bg-yellow-700 transition-colors font-semibold">
                        Pay Registration Fee Now
                    </a>
                    <p class="text-sm text-yellow-600 mt-3">Your application will be processed after payment is confirmed.</p>
                </div>
                @endif
                ...
                <!-- Next Steps (Conditional based on payment) -->
                @if($hasPayment)
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm text-blue-700">You'll receive an email with your admission status and further instructions.</p>
                        </div>
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
                    <h3 class="text-xl font-semibold text-yellow-800 mb-4">Next Steps</h3>
                    <div class="flex flex-col items-center space-y-4">
                        <div class="flex items-start">
                            <div class="w-8 h-8 bg-yellow-200 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                                <span class="text-yellow-800 font-bold">1</span>
                            </div>
                            <p class="text-yellow-700 text-left">Complete the payment of <strong>KES 500</strong> registration fee via M-Pesa</p>
                        </div>
                        <div class="flex items-start">
                            <div class="w-8 h-8 bg-yellow-200 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                                <span class="text-yellow-800 font-bold">2</span>
                            </div>
                            <p class="text-yellow-700 text-left">Once payment is confirmed, your application will be queued for review</p>
                        </div>
                        <div class="flex items-start">
                            <div class="w-8 h-8 bg-yellow-200 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                                <span class="text-yellow-800 font-bold">3</span>
                            </div>
                            <p class="text-yellow-700 text-left">You'll receive a confirmation SMS and email within 24 hours</p>
                        </div>
                        <a href="{{ route('application.payment.form', $application->id) }}"
                           class="mt-4 bg-yellow-600 text-white px-8 py-3 rounded-lg hover:bg-yellow-700 transition-colors font-semibold">
                            Pay Registration Fee Now
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
                    ...
                    <ul class="text-left space-y-2 text-yellow-700">
                        ...
                        <li class="flex items-start">
                            ...
                            <span>Contact admissions if you don't hear back within 5 business days after payment</span>
                        </li>
                    </ul>
                </div>
    ...
    const paymentCheckInterval = setInterval(function() {
        ...
        .then(data => {
            if (data.success && data.status === 'completed') {
                ...
                location.reload(); // Reload to show payment success
            }
        })
