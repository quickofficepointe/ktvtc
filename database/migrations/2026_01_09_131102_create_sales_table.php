...
return new class extends Migration
{
 ...
 $table->string('kcb_invoice_number')->nullable();
            ...
            $table->enum('customer_type', ['student', 'staff', 'visitor', 'online_customer'])->nullable();
        ...
        Schema::create('payment_transactions', function (Blueprint $table) {
            ...
            // Payment details
            $table->enum('payment_method', ['mpesa', 'cash', 'card', 'bank_transfer']);
 ...
 $table->string('kcb_invoice_number')->nullable();
        ...
        Schema::create('order_status_history', function (Blueprint $table) {
            ...
            // Indexes
            $table->index('sale_id');
            $table->index('kcb_invoice_number');
            $table->index('status');
        });
    }
